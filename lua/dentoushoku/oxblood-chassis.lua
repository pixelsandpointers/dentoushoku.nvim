...
function M.setup(opts)
  ...
  hl("@function.method",     { fg = p.cyan_br })
  hl("@function.method.call", { fg = p.cyan_br })
  ...
  hl("@keyword.modifier",              { fg = p.oxblood_br })
  hl("@keyword.type",                  { fg = p.gold_br, italic = true })
  hl("@keyword.coroutine",             { fg = p.oxblood_br, bold = true })
  hl("@keyword.exception",             { fg = p.oxblood_br, bold = true })
  hl("@keyword.repeat",                { fg = p.oxblood_br })
  hl("@keyword.conditional",           { fg = p.oxblood_br })
  hl("@keyword.conditional.ternary",   { fg = p.lavender_br })
  hl("@keyword.import",                { fg = p.lavender_br })
  hl("@keyword.directive",             { fg = p.lavender_br })
  hl("@keyword.directive.define",      { fg = p.lavender_br })
  hl("@conditional",         { fg = p.oxblood_br })
  hl("@repeat",              { fg = p.oxblood_br })
  hl("@exception",           { fg = p.oxblood_br, bold = true })
