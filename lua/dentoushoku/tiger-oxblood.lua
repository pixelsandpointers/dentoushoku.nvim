-- ============================================================================
-- tiger-oxblood.nvim
-- Sibling to tiger-ink, with the core-gem accent swapped from burnt
-- red-orange to true oxblood -- separating the secondary accent cleanly
-- from the warm orange-red pistol-glow accent (used for warnings/diffs).
-- Grey tiger-tattoo linework -> structural greys, gold lightning-bolt
-- frame -> primary accent, oxblood core -> secondary accent, dual pistol
-- glows (orange-red / cyan-blue) -> warm/cool accents.
...
M.palette = {
  ...
  oxblood     = "#922c33", -- secondary accent: core gem, errors, exceptions
  oxblood_br  = "#b8393f",
  oxblood_deep = "#4a1d22", -- selection bg, danger fill

  orange      = "#b85838", -- warm pistol glow: warnings, diff-delete
  orange_br   = "#d97048",
...
function M.setup(opts)
  ...
  vim.g.colors_name = "tiger-oxblood"
  ...
  hl("Visual",       { bg = p.oxblood_deep })
  hl("VisualNOS",    { bg = p.oxblood_deep })
  ...
  hl("Special",      { fg = p.orange_br })
  hl("SpecialChar",  { fg = p.orange_br })
  hl("Tag",          { fg = p.gold })
  ...
  hl("@string.special",      { fg = p.orange_br })
  hl("@character",           { fg = p.cyan })
  hl("@number",              { fg = p.mauve_br })
  hl("@boolean",             { fg = p.mauve_br, bold = true })
  ...
  hl("@keyword.exception",             { fg = p.oxblood_br, bold = true })
  ...
  hl("@punctuation.special", { fg = p.orange_br })
  ...
  hl("LspReferenceWrite", { bg = p.oxblood_deep })
